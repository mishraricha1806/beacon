...
def decide_action(runtime):
    ...
    config_weak = (
        retention_bytes_configured is False
        or cleanup_policy_configured is False
    )

    workload_changed = (
        producer_rate_increased
        or avg_message_size_increased
        or consumer_lag_increasing
    )
    ...
    if disk_usage >= 80 and not config_weak and not workload_changed and disk_growth_7d < 10:
        return {
            "severity": "MEDIUM",
