"""Rule metadata registry for Beacon's registered-rule architecture.

This module loads canonical YAML metadata, environment-provided overrides,
metadata emitted by registered rule objects, and runtime-only metadata used by
connectors. Legacy imports should go through ``beacon.rules_registry``.
"""
...
RUNTIME_RULES: Dict[str, Dict[str, Any]] = {
    ...
    "kafka.acl.export.empty": {
        "title": "Kafka ACL export empty",
        "description": "An offline Kafka ACL export contained no ACL bindings.",
        "severity_default": "HIGH",
        "category": "operational_safety",
        "author": "beacon.runtime",
        "recommendation": "Verify authorizer configuration and export all production ACLs for review.",
    },
    "kafka.acl.export.broad_allow": {
        "title": "Kafka ACL export broad allow",
        "description": "An offline Kafka ACL export includes broad wildcard or all-operation allow permissions.",
        "severity_default": "HIGH",
        "category": "operational_safety",
        "author": "beacon.runtime",
        "recommendation": "Replace wildcard or all-operation ACLs with scoped topic, group, and transactional-id permissions.",
    ...
    "kafka.acl.export.inspected": {
        "title": "Kafka ACL export inspected",
        "description": "Beacon inspected the offline ACL export and did not detect broad allow patterns.",
        "severity_default": "LOW",
        "category": "operational_safety",
        "author": "beacon.runtime",
        "recommendation": "Continue reviewing ACL exports during production readiness checks.",
    },
    "kafka.history.insufficient_snapshots": {
        "title": "Kafka history insufficient snapshots",
        "description": "Kafka history input did not contain enough snapshots for trend diagnostics.",
        "severity_default": "LOW",
        "category": "runtime_stability",
        "author": "beacon.runtime",
        "recommendation": "Collect multiple snapshots over time or upload a history export.",
    },
    "kafka.history.trend.inspected": {
        "title": "Kafka history trend inspected",
        "description": "Beacon inspected Kafka runtime history and did not detect worsening trends.",
        "severity_default": "LOW",
        "category": "runtime_stability",
        "author": "beacon.runtime",
        "recommendation": "Continue collecting snapshots before and during high-traffic events.",
    },
    "kafka.history.disk_usage.growing": {
        "title": "Kafka disk usage growing",
        "description": "Kafka broker disk usage is increasing across history snapshots.",
        "severity_default": "HIGH",
        "category": "runtime_stability",
        "author": "beacon.runtime",
        "recommendation": "Review retention, producer volume, topic growth, broker skew, and capacity runway.",
    },
    "kafka.history.consumer_lag.growing": {
        "title": "Kafka consumer lag growing",
        "description": "Kafka consumer lag is increasing across history snapshots.",
        "severity_default": "HIGH",
        "category": "runtime_stability",
        "author": "beacon.runtime",
        "recommendation": "Investigate consumer processing latency, downstream dependencies, retry loops, hot partitions, and recent deployments.",
    },
    "kafka.history.controller_churn.high": {
        "title": "Kafka controller churn high",
        "description": "Kafka controller churn is high in recent history.",
        "severity_default": "HIGH",
        "category": "runtime_stability",
        "author": "beacon.runtime",
        "recommendation": "Inspect controller logs, broker churn, quorum health, GC pauses, and network instability.",
    },
    "kafka.history.rebalance_churn.high": {
        "title": "Kafka rebalance churn high",
        "description": "Kafka rebalance churn is high in recent history.",
        "severity_default": "HIGH",
        "category": "runtime_stability",
        "author": "beacon.runtime",
        "recommendation": "Inspect deployments, heartbeat/session timeout, max.poll.interval.ms, and consumer crashes.",
    },
    "kafka.history.consumer_group.member_churn": {
        "title": "Kafka historical consumer group member churn",
        "description": "Consumer group membership changed repeatedly across history snapshots.",
        "severity_default": "HIGH",
        "category": "runtime_stability",
        "author": "beacon.runtime",
        "recommendation": "Inspect rolling deployments, pod restarts, session timeout, heartbeat interval, max.poll.interval.ms, and consumer crashes.",
    },
