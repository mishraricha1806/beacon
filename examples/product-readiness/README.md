...
| `distributed-infra-risk` | Kubernetes, Kafka, database, IAM, and object-storage readiness blockers: unsafe PDB, no HPA headroom, weak admission/RBAC/secret posture, unsafe Kafka client transport, broad IAM policy attachment, missing DB recovery/encryption controls, and weak bucket recovery posture. |
